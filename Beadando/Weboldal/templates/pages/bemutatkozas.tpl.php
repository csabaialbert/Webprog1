<body>
    ...
    <p>Egy maroknyi, lelkes, állatszerető ember összefogásában 1999-ben létrejött a Csömöri Állatvédő Civil Szervezet, hogy megpróbáljunk segíteni a kidobott, elhagyott, gazdátlan kutyákon. Pár nap gondoskodás után is az szívünkhöz nőttek kis védenceik és reméltük, hogy mi találunk nekik mihamarabb gazdit, és nem kerülnek gyepmesteri telepre.
        ...
        A szuka kutyák kizárólag oltva, ivartalanítva és chipezve kerülhetnek gazdihoz, a kan kutyákat is ivartalanítjuk, illetve természetesen oltatjuk, chippel látjuk el, ehhez mérten az állatorvosi költségek tetemes összeget visznek el a menhely pénztárából.
    ...
    <p id="idézet">Önkénteseink valamennyien a saját szabadidejük terhére,
        a munka és a család mellett végzik mentési feladataikat,
        a menhelyi munkákat, adminisztrációs tevékenységeket.
        A menhelyet adományokból tartjuk fenn.
    </p>
    <p>A felesleges szaporulatot elkerülvén a lehetőségeinkhez képest a rászoruló lakosok kedvencei részére kedvezményes ivartalanítását biztosítunk.
